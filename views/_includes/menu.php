...
<head>
    ...
    <link href="<? echo URL ?>/views/_includes/fontawesome/css/all.css" rel="stylesheet">
    
    <script defer src="<? echo URL ?>/views/_includes/fontawesome/js/all.js"></script> 
    <script src="<? echo JS ?>jquery.min.js"></script>
    <script> var URL_JS = '<? echo URL ?>'; </script>
    <script src="<? echo JS ?>funcoesPainel.js"></script>
...
<body>
    ...
    <nav id="menu" class="col-md-2">
        ...
        <ul>
            ...
            <li><a href="<?php echo URL ?>/controlpanel/relatorios">Relatórios</a></li>
        </ul>
